...
const AddToCartSingleProductBtn = ({ product, quantityCount } : SingleProductBtnProps) => {
  ...
  return (
    <button
      ...
      className="btn w-[200px] text-lg border border-brand-border border-1 font-normal bg-brand-surface text-brand-primary hover:bg-brand-primary hover:text-brand-primary-content hover:border-brand-primary hover:scale-110 transition-all uppercase ease-in max-[500px]:w-full"
    >
      Add to cart
    </button>
  );
