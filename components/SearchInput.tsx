...
const SearchInput = () => {
  ...
  return (
    <form className="flex w-full justify-center" onSubmit={searchProducts}>
      ...
      />
      <button type="submit" className="btn bg-brand-primary text-brand-primary-content border-brand-primary rounded-l-none rounded-r-xl hover:bg-brand-primary-hover hover:border-brand-primary-hover">
        Search
      </button>
    </form>
  );
