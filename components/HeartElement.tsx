  ...
  return (
    <div className="relative">
      <Link href="/wishlist">
        ...
        <span className="block w-6 h-6 font-bold bg-brand-primary text-brand-primary-content rounded-full flex justify-center items-center absolute top-[-17px] right-[-22px]">
          { wishQuantity }
        </span>
      </Link>
    </div>
