...
const DashboardSidebar = () => {
  return (
    <div className="xl:w-[400px] bg-brand-primary text-brand-primary-content h-full max-xl:w-full">
      <Link href="/admin">
        <div className="flex gap-x-2 w-full hover:bg-brand-primary-hover cursor-pointer items-center py-6 pl-5 text-xl text-white">
