      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-3 mb-2">
            <FaBell className="text-2xl text-brand-primary" />
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
          ...
          <form onSubmit={handleSearch} className="mb-4">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-brand-primary focus:border-brand-primary outline-none"
              />
              <button
                type="submit"
                className="absolute right-2 top-1/2 transform -translate-y-1/2 px-4 py-1 bg-brand-primary text-white text-sm rounded hover:bg-brand-primary focus:outline-none focus:ring-2 focus:ring-brand-primary focus:ring-offset-1"
              >
                Search
              </button>
            </div>
          ...
          <div className="flex flex-wrap gap-4 items-center">
            ...
            <select
              ...
              className="px-3 py-1 border border-gray-300 rounded-md text-sm focus:ring-2 focus:ring-brand-primary focus:border-brand-primary outline-none"
            >
        ...
        {selectedIds.length > 0 && (
          <div className="bg-brand-surface-alt border border-brand-border rounded-lg p-4 mb-6">
            <div className="flex items-center justify-between">
              ...
              <div className="flex space-x-3">
                <button
                  ...
                  className="inline-flex items-center px-3 py-1 text-sm font-medium text-brand-primary bg-white border border-brand-border rounded-md hover:bg-brand-surface-alt focus:outline-none focus:ring-2 focus:ring-brand-primary focus:ring-offset-1"
                >
          ...
          {loading && notifications.length === 0 ? (
            ...
            <div className="text-center py-12">
              ...
              <button
                ...
                className="px-4 py-2 bg-brand-primary text-white rounded-md hover:bg-brand-primary focus:outline-none focus:ring-2 focus:ring-brand-primary focus:ring-offset-2"
              >
                Try Again
              </button>
            </div>
              ...
              {page < totalPages && (
                <div className="text-center pt-6">
                  <button
                    onClick={loadMore}
                    disabled={loading}
                    className="px-6 py-2 bg-brand-primary text-white rounded-md hover:bg-brand-primary focus:outline-none focus:ring-2 focus:ring-brand-primary focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {loading ? (
                      <>
